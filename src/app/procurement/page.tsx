...
export default function ProcurementDashboardPage() {
  ...
  const pipelineStages = [
    ...
    { name: '4. Purchase Invoices', count: unpaidInvoices, subtext: 'Commercial bills', link: '/procurement/invoices', desc: 'Register vendor bill against PO rates & terms.', color: 'border-amber-200 hover:border-amber-400 bg-amber-50 text-amber-900 hover:shadow-md hover:scale-[1.02]', badgeColor: 'bg-amber-600 text-white' },
    { name: '5. Quality Control', count: pendingQcCount, subtext: 'Awaiting QC', link: '/procurement/qc', desc: 'Lab testing: moisture, purity & quality rebates.', color: 'border-pink-200 hover:border-pink-400 bg-pink-50 text-pink-900 hover:shadow-md hover:scale-[1.02]', badgeColor: 'bg-pink-600 text-white' },
    { name: '6. Inward (GRN)', count: grns.filter(g => g.inwardStatus !== 'Completed').length, subtext: 'Pending inwarding', link: '/procurement/grn', desc: 'Weighbridge check, batching & bin inwarding.', color: 'border-purple-200 hover:border-purple-400 bg-purple-50 text-purple-900 hover:shadow-md hover:scale-[1.02]', badgeColor: 'bg-purple-600 text-white' },
    { name: '7. Vendor Payout', count: grns.filter(g => g.inwardStatus === 'Completed').length, subtext: 'Pay after GRN', link: '/procurement/grn', desc: 'Release payment voucher to vendor & take receipt.', color: 'border-emerald-200 hover:border-emerald-400 bg-emerald-50 text-emerald-900 hover:shadow-md hover:scale-[1.02]', badgeColor: 'bg-emerald-600 text-white' },
    { name: '8. Returns', count: draftReturns, subtext: 'Active returns', link: '/procurement/returns', desc: 'Send back defective stock & book debit notes.', color: 'border-rose-200 hover:border-rose-400 bg-rose-50 text-rose-900 hover:shadow-md hover:scale-[1.02]', badgeColor: 'bg-rose-600 text-white' },
  ];

      ...
      try {
        ...
        try {
          ...
          currentDb.grns = list.map((item: any) => ({
              ...
              remarks: item.remarks || '',
              photos: item.photos || (item.attachments && item.attachments.length > 0 ? item.attachments : (item.attachment ? [item.attachment] : [])),
              attachments: item.attachments || item.photos || [],
              attachment: item.attachment || (item.photos && item.photos[0]) || '',
